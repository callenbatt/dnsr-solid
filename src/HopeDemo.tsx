  ...
  return (
    ...
    >
      ...
      <Box p={5}>
        ...
        <Text
          size="sm"
          color={{ light: "neutral.500", dark: "neutral.400" }}
          mb={3}
        >
          Yosemite National Park is an American national park in California,
          surrounded on the southeast by the Sierra National Forest and on the
          northwest by the Stanislaus National Forest.
        </Text>
